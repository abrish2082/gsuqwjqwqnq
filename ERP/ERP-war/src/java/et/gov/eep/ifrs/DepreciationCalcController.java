 ...
 * @author user
 */
@Named("depreciationCalcControllers")
@ViewScoped
public class DepreciationCalcController implements Serializable {
...
//</editor-fold>
Double depreciationAnyPeriod;

    public Double getDepreciationAnyPeriod() {
        return depreciationAnyPeriod;
    }

    public void setDepreciationAnyPeriod(Double depreciationAnyPeriod) {
        this.depreciationAnyPeriod = depreciationAnyPeriod;
    }
        ...
        try {
            ...
            if (event.getNewValue().toString() != null) {
                ...
                for (int i = 0; i < fixedAssetlist.size(); i++) {
                 ...
                 ifrsFixedAsset.setNetBookValue(String.valueOf(depreciationAnyPeriod));
                }
...
//    public ArrayList deprciationList = new ArrayList();
    ...
    public void getListOfAttributesByCategory(ValueChangeEvent e) {
        System.out.println("---------event-----"+e.getNewValue().toString());
        String currentDate = StringDateManipulation.toDayInEc();
        fixedAssets.clear();
...
//                ifrsFixedAsset.setAccumulatedDepreciation(accumulateDep);
//                ifrsFixedAsset.setNetBookValue(bookValue);
